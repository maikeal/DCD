...
api = twitter.Api(consumer_key='giugiugugibivcccyhjcjyv',
                  consumer_secret='cgcuyfuigkjhihhiohihoihohbiub',
                  access_token_key='chgchgcjhgjgkgjgjgjhkhl',
                  access_token_secret='vjjvhvkujbjkblknkjblklkkbbjkbjkbkjb')
